  ...
  20: [
    {
      ...
      points: [
        ...
        "Most launches fail because people just 'put it out there'",
        "That's a WISH, not a strategy",
      ],
    },
    {
      title: "A Real Launch",
      points: [
        ...
        "Set an actual launch DATE (not 'soon')",
        "Have a week-by-week action plan",
    ...
    },
    {
      ...
      points: [
        ...
        "Week 2: Soft launch (inner circle)",
