...
const slideContent: Record<number, Slide[]> = {
  ...
  15: [
    {
      ...
      points: [
        "Today your app learns to take money",
        "This is the plumbing that makes revenue possible",
        "We're setting up Stripe in test mode",
      ],
    },
    {
      title: "Picking a Pricing Model",
      points: [
        "Subscription, one-time, usage-based, or freemium",
        "Any of these can work - look at similar apps",
        "You can always change it later",
        "Don't overthink - just pick one and move on",
      ],
    },
    {
      title: "Your Task Today",
  ...
  16: [
    {
      title: "Day 16: Mobile & Speed",
      points: [
        "Two things KILL apps - broken mobile and slow loading",
        "Half your users are on their PHONE",
        "53% abandon if loading takes over 3 seconds",
      ],
    },
    {
      title: "Mobile Testing",
      points: [
        "Test on your REAL phone (not just browser dev tools)",
    ...
    },
    {
      ...
      points: [
        ...
        "Do you see content immediately (no blank screen)?",
    ...
    },
    {
      ...
      points: [
        ...
        "Fast + mobile-ready = competitive advantage",
      ],
    },
  ],
  17: [
    ...
    {
      title: "The Truth About Bugs",
      points: [
        "You WILL ship with bugs. Every app does.",
        "Real users find edge cases you'd never think of",
        "That's not failure - that's how software works",
        "Beta testers are your secret weapon",
      ],
    },
    {
    ...
    },
    {
      title: "The Mindset",
      points: [
        "Stop hunting for every bug",
        "Find BLOCKING bugs - things that stop the main task",
        "Fix those. Ship the rest.",
        "Real users will tell you what's actually broken",
      ],
    },
  ],
  18: [
